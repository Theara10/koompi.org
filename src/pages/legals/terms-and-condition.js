...
const Terms = () => {
  return (
    <React.Fragment>
      <MetaTage
        title="terms & condictions | koompi.org"
      ...
      <div className="container">
        <div className="legals-background">
          <p>
            Last updated: March 19, 2020 <br /> Please read these terms and
            conditions carefully before using Our Service. <br />
          ...
          <ul>
            ...
            <li>
              ...
              in this Agreement) refers to KOOMPI Co., Ltd. , Phnom Penh .
            </li>
            <li>Country refers to: Cambodia.</li>
            ...
            <li>
              ...
              Conditions agreement has been created with the help of Terms and
            ...
            <li>Website refers to KOOMPI, accessible from koompi.com</li>
            <li>
