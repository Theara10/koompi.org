  ...
  return (
    <div>
      <MetaTage
        ...
        thumbnail="http://www.koompi.org/images/thumbnail/homepage.png"
      />
          ...
          <div className="container">
            <div className="banner-contents">
              ...
              <p className="banner-desc">
                This website is the official encyclopedia for KOOMPI projects
                and initiatives. Read about our contribution to the open-source
                community below!
              </p>
            </div>
          </div>
